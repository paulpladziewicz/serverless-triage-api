...
**NOTE:** This uses the logical name of the function within the stack. This is the correct name to use when searching logs inside an AWS Lambda function within a CloudFormation stack, even if the deployed function name consties due to CloudFormation's unique resource name generation.
...
```bash
aws cloudformation delete-stack --stack-name kayode-triage-api-backend
```
